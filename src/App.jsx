...
export default function PlantDiseaseUI() {
  ...
  const [selectedPlant, setSelectedPlant] = useState('auto');
      ...
      return (
        <div className="flex items-center justify-center min-h-screen bg-gray-900 p-4">
            <div className="bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-700 max-w-md text-center">
                ...
                <div className="bg-gray-900 p-3 rounded text-left text-xs font-mono text-gray-500 mb-4 border border-gray-700">
           ...
           <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4">
                <button 
                  ...
                  className="text-gray-400 hover:text-green-400 font-medium transition-colors"
                >
                  Sign In
                </button>
                <button 
                  onClick={() => { setIsSignUp(true); setCurrentTab('auth'); }}
                  className="bg-green-600 hover:bg-green-500 text-white px-6 py-2.5 rounded-full font-semibold transition-all shadow-lg shadow-green-900/20"
                >
                  Get Started
                </button>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button 
                  onClick={() => { setIsSignUp(true); setCurrentTab('auth'); }}
                  className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-500 text-white px-8 py-4 rounded-xl text-lg font-bold transition-all shadow-xl shadow-green-900/20 transform hover:-translate-y-1"
                >
                  Start Diagnosing <ArrowRight className="w-5 h-5" />
                </button>
                <button 
                  onClick={() => document.getElementById('features').scrollIntoView({ behavior: 'smooth' })}
                  className="flex items-center justify-center gap-2 bg-gray-900 border-2 border-gray-700 hover:border-green-500 hover:bg-gray-800 text-gray-300 px-8 py-4 rounded-xl text-lg font-bold transition-all"
                >
                  Learn More
                </button>
              </div>
              <div className="flex items-center gap-4 text-sm text-gray-500 pt-4">
                <div className="flex -space-x-2">
                  {[1,2,3].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gray-800 border-2 border-gray-950 flex items-center justify-center text-xs font-bold text-gray-400">
                      {i}
                    </div>
                  ))}
                </div>
            ...
            <div className="relative">
              <div className="absolute top-10 right-10 w-72 h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-20 animate-blob"></div>
              <div className="absolute top-10 -left-10 w-72 h-72 bg-green-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-20 animate-blob animation-delay-2000"></div>
              
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-800 transform rotate-2 hover:rotate-0 transition-all duration-500 group">
                <img 
                  src="garden.png" 
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-gray-900/90 backdrop-blur-md border border-gray-700 p-4 rounded-xl shadow-lg flex items-center gap-4 animate-bounce-slow">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-700 hover:border-gray-600 transition-colors">
                ...
                <p className="text-gray-400 leading-relaxed">Simply snap a photo and get results in seconds. No internet? Offline mode is coming soon.</p>
              </div>
              ...
              <div className="bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-700 hover:border-gray-600 transition-colors">
                ...
                <p className="text-gray-400 leading-relaxed">Don't just diagnose—cure. We provide organic and chemical treatment plans for every disease.</p>
              </div>
              ...
              <div className="bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-700 hover:border-gray-600 transition-colors">
                ...
                <p className="text-gray-400 leading-relaxed">Keep a digital log of your farm's health. Monitor disease spread and recovery over time.</p>
              </div>
            </div>
          </div>
        </section>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full pl-10 pr-4 py-2 bg-gray-900 border border-gray-700 text-white rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all placeholder-gray-600"
          ...
          <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
             <div 
              ...
              <div className="flex items-center bg-gray-950 border border-gray-800 rounded-lg p-1">
                  <button 
                    onClick={() => setCurrentTab('home')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${currentTab === 'home' ? 'bg-gray-800 text-green-400 shadow-sm border border-gray-700' : 'text-gray-400 hover:text-gray-200'}`}
                  >
                    <Home className="w-4 h-4" /> Home
                  </button>
                  <button 
                    onClick={() => setCurrentTab('scanner')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${currentTab === 'scanner' ? 'bg-gray-800 text-green-400 shadow-sm border border-gray-700' : 'text-gray-400 hover:text-gray-200'}`}
                  >
                    <Smartphone className="w-4 h-4" /> Scanner
                  </button>
                  <button 
                    onClick={() => setCurrentTab('history')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${currentTab === 'history' ? 'bg-gray-800 text-green-400 shadow-sm border border-gray-700' : 'text-gray-400 hover:text-gray-200'}`}
                  >
                    <History className="w-4 h-4" /> History
                  </button>
                  <button 
                    onClick={() => setCurrentTab('info')}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${currentTab === 'info' ? 'bg-gray-800 text-green-400 shadow-sm border border-gray-700' : 'text-gray-400 hover:text-gray-200'}`}
                  >
              ...
              <div className="flex items-center gap-3">
                  <div className={`hidden md:flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium border ${
                      serverStatus === 'connected' ? 'bg-green-900/30 text-green-400 border-green-800/50' : 'bg-red-900/30 text-red-400 border-red-800/50'
                    }`}>
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full p-4 md:p-6">
          ...
          <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="bg-gray-900 rounded-3xl p-8 shadow-lg border border-gray-800 flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 space-y-4">
                ...
                <button 
                  onClick={() => setCurrentTab('scanner')}
                  className="bg-green-600 hover:bg-green-500 text-white px-6 py-3 rounded-xl font-semibold shadow-lg shadow-green-900/20 transition-all flex items-center gap-2"
                >
        ...
        {currentTab === 'scanner' && (
          <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-500">
            <div className="bg-gray-900 rounded-3xl shadow-xl border border-gray-800 overflow-hidden">
                ...
                <div className="mb-6">
                    ...
                    <select 
                        ...
                        className="w-full bg-gray-950 border border-gray-700 text-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all font-medium cursor-pointer"
                    >
                ...
                {!preview ? (
                    ...
                    <div className="relative rounded-2xl overflow-hidden bg-black shadow-inner border border-gray-800 h-64 flex items-center justify-center group">
                ...
                <div className="bg-gray-950 px-8 py-6 border-t border-gray-800 flex items-center justify-between">
                    {preview && !isLoading && !result && (
                    <div className="flex-1 flex justify-end">
                        <button onClick={sendFile} disabled={serverStatus === 'disconnected'} className="bg-green-600 hover:bg-green-500 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold py-3 px-8 rounded-xl shadow-lg shadow-green-900/20 transition-all flex items-center gap-2">
            ...
            {error && (
                <div className="bg-red-900/20 border border-red-800/50 rounded-xl p-4 text-red-400 text-sm flex items-center gap-2 animate-in fade-in slide-in-from-top-2">
